...
echo '<div class="payment ">
      ...
      <form method="post" action="../../php/defcolor.php"  class="is-vertically-scrollable"> 
        <p id=p1>Identifica relaciones de causa y efecto entre los componentes de una situación a resolver
</p>
        ...
        <p id=p2>Se adaptan fácilmente al los diferentes procesos o contextos para resolver problemas
</p>
        ...
        <p id=p3>Controla y verifica las contribuciones individuales demandadas por los proyectos
</p>
        ...
        <p id=p4>Es perseverante frente a las dificultades, convirtiéndolas en oportunidades
</p>
        ...
        <p id=p5>Capacidad de entender una situación, evaluando las diferentes variables que inciden en la consecución de un objetivo y su viabilidad
        ...
        <p id=p6>Domina su área de especialización mediante sólidos fundamentos derivados de su conocimiento y experiencia general
        ...
        <p id=p7>Identifica , analiza y propone soluciones a problemas técnicos de alta complejidad
